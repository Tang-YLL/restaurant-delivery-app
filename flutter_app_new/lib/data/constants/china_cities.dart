/// 中国省市区数据
const Map<String, Map<String, List<String>>> chinaCities = {
  '北京市': {
  ...
  '湖南省': {
    ...
    '株洲市': ['荷塘区', '芦淞区', '石峰区', '天元区', '渌口区', '株洲县', '攸县', '茶陵县', '炎陵县', '醴陵市'],
    ...
    '永州市': ['零陵区', '冷水滩区', '祁阳市', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华瑶族自治县'],
    '怀化市': ['鹤城区', '中方县', '沅陵县', '辰溪县', '溆浦县', '麻阳苗族自治县', '新晃侗族自治县', '芷江侗族自治县', '会同县', '靖州苗族侗族自治县', '通道侗族自治县', '洪江市'],
  ...
  '河南省': {
    ...
    '安阳市': ['文峰区', '北关区', '殷都区', '龙安区', '汤阴县', '安阳县', '内黄县', '林州市'],
    ...
    '周口市': ['川汇区', '淮阳区', '扶沟县', '西华县', '商水县', '太康县', '鹿邑县', '沈丘县', '郸城县', '项城市'],
  ...
  '陕西省': {
    ...
    '延安市': ['宝塔区', '延长县', '延川县', '子长市', '安塞区', '志丹县', '吴起县', '甘泉县', '富县', '洛川县', '宜川县', '黄龙县', '黄陵县'],
  ...
  '安徽省': {
    ...
    '六安市': ['金安区', '裕安区', '叶集区', '霍山县', '舒城县', '金寨县', '霍邱县'],
    '亳州市': ['谯城区', '涡阳县', '蒙城县', '利辛县'],
    '池州市': ['贵池区', '东至县', '石台县', '青阳县'],
